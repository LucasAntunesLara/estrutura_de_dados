...
class List {
    ...
    retornarNodePelaPosicao(nodeNumber) {
        let nodeAtual = this.inicio
        let lista = []

        
        while (nodeAtual !== null) {
            lista.push(nodeAtual.value)
            
            if (nodeNumber === lista.length) return nodeAtual.value
            
            nodeAtual = nodeAtual.next
        }
        
        return null
        // return 'Não existe nó com o número informado'
    }
...
lista1.inserirEmOrdemCrescente(13)
//lista1.inserirEmOrdemCrescente(14)

// console.log(lista1.c)
console.log(lista1.retornarNodePelaPosicao(3))